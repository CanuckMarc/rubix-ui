...
export const CustomEdge = (props: EdgeProps & { parentNodeId?: string }) => {
  ...
  useEffect(() => {
    ...
    if (show) {
      ...
      const newSourceY = sourceIndex >= 0 && parentNode ? parentNode!!.position.y + (70 + sourceIndex * 32) : sourceY;
      ...
      const newTargetY = targetIndex >= 0 && parentNode ? parentNode!!.position.y + (70 + targetIndex * 32) : targetY;
